...
def drawHealthMeter(currentHealth):
    ...
    for i in range(MAXHEALTH): #draw white health bars
...
def getBounceAmount(currentBounce, bounceRate, bounceHeight):
    ...
    #Larger bounceHeight means a heigher bounce
    #currentBounce will always less than bounceRate
...
def isOutsideActiveArea(camerax, cameray, obj):
    #Return False if camerax and cameray are more than a half-window length beyond the edge of window
