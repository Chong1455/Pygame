...
assert(BOARDWIDTH * BOARDHEIGHT) % 2 == 0, \
    'Board needs to have an even number of boxed for pairs of matches.'
...
def splitIntoGroupsOf(groupSize, theList):
    #splits a list into a list of lists, where the ineer lists have at
...
def hasWon(revealedBoxes):
    ...
    for i in revealedBoxes:
        if False in i:
            return False #return Flase if any boxes are covered
    return True
